...
def parser_input():
    ...
    # Parse arguments :
    parser = argparse.ArgumentParser(description="Minimize a pdb structure in 2 steps, the first step without bonds constraints and the second step with")
    ...
    parser.add_argument('-box', action="store", dest="box", help='Create a box, default=False', type=bool, default=False)
...
if __name__ == "__main__":
    ...
    sys_min.em_2_steps(out_folder = args.o,	name = args.name, no_constr_nsteps = args.min_steps, constr_nsteps = args.min_steps,
